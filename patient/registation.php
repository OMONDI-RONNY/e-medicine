...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $stmt = $conn->prepare("INSERT INTO patients (PatientID,firstname,lastname,Email,Age,password) VALUES (?, ?, ? ,? ,? ,?)");
    $stmt->bind_param('isssss', $username,$firstname, $lastname, $email, $age,  $password);
    ...
    <div class="right">
        <div class="registration-card">
            ...
            <form action="registation.php" method="post">
                <input type="number" name="username" placeholder="Patient ID" required>
